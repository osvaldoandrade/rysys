...
/**
 * Utility class for EisListenerMD.
 * 
 ...
 * @version ${version}
 */
public class EisListenerMDUtil {

	/**
	 * Cached queue (javax.jms.Queue). Uses lazy loading to obtain its value
	 * (loaded by getQueue() methods).
	 */
	 ...
	 * 
	 * @return Destination JMS Queue for EisListenerMD. Lookup using COMP_NAME
	 */
	public static javax.jms.Queue getQueue()
		...
		if (cachedQueue == null) {
			...
			try {
				java.lang.Object objRef = initialContext
						.lookup(DESTINATION_JNDI_NAME);
	 ...
	 * Obtain destination queue from default initial context
	 * 
	 * @return Destination JMS Connection Factory for EisListenerMD. Lookup
	 *         using COMP_NAME
	 */
	...
	public static javax.jms.QueueConnection getQueueConnection(
		...
		try {
			java.lang.Object objRef = initialContext
					.lookup(CONNECTION_FACTORY_JNDI_NAME);
			return ((javax.jms.QueueConnectionFactory) objRef)
	...
	public static final String generateGUID(Object o) {
		...
		if (hexServerIP == null) {
			...
			try {
				...
				System.err
						.println("EisListenerMDUtil: Could not get the local IP address using InetAddress.getLocalHost()!");
